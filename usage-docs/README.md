...
Here is a collection of docs to help users as they interact with both
Hachyderm and the broader Mastodon FediVerse. This expands on the getting
started information that was presented in the [welcome to Hachyderm](../welcome/README.md)
doc.

## Table of Contents

1. This doc - the Rule Explainer
1. [How to use content warnings](how-to-use-content-warnings.md)

## The Rule Explainer

The Rules / Code of Conduct are the most important thing to understand when
on Hachyderm, so we're putting it right here in this README rather than
another document. A quick recap of the rules:
