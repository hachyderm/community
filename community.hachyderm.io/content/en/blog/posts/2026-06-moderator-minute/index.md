...
A note before we begin, and as with the rest of this series: these posts run a little denser than our usual Moderator Minutes, and we don't expect anyone to absorb all of it at once. We'll keep the recap short, because each post is meant to stand on its own, but if you'd like the fuller picture: [Part 1](https://community.hachyderm.io/blog/2026/02/26/a-minute-from-the-moderators/) looked at how shifting norms create friction, and asked you to sit with a question: *is it working?* [Part 2](https://community.hachyderm.io/blog/2026/04/27/a-minute-from-the-moderators/) looked at what drives us toward confrontation in the first place, and at the idea of **care webs**: the networks of mutual support that let us do collective work without each of us carrying it alone.
...
We know a lot of people are running low right now, so we'll keep the prompt light this time: what is a content filter or mute you would recommend to someone new to the Fediverse? Answer wherever feels easy, in [Zulip](https://nivenly.zulipchat.com/) or out on the Fediverse with \#CommunityCare. As a reminder: we're not automating the Discord to Zulip migration, so please check in Discord for information for how to be added to Zulip.
## Further reading

*(Many of these can also be found at the Further Reading section of Part 2.)*

**On calling in and calling out.** The phrase "calling in" comes from Ngọc Loan Trần's 2013 essay "Calling IN: A Less Disposable Way of Holding Each Other Accountable," published on [Black Girl Dangerous](https://www.bgdblog.org/2013/12/calling-less-disposable-way-holding-accountable/) and archived on [TransformHarm.org](https://transformharm.org/calling-in-a-less-disposable-way-of-holding-each-other-accountable/). Loretta Ross has spent the decade since turning the idea into something teachable, drawing on five decades of organizing. Her [TED talk](https://www.ted.com/talks/loretta_j_ross_don_t_call_people_out_call_them_in) runs about fifteen minutes and is a good place to start. Her book [Calling In: How to Start Making Change with Those You'd Rather Cancel](https://www.simonandschuster.com/books/Calling-In/Loretta-J-Ross/9781982190804) (Simon & Schuster, 2025) develops a five-part continuum of responses (canceling, calling out, calling off, calling on, and calling in) with practical guidance on when each one fits.
 
**On online harassment and digital safety.** Each is most useful read before you need it; the differences are in emphasis.
 
* [PEN America's Online Harassment Field Manual](https://onlineharassmentfieldmanual.pen.org/): organized by your role in the situation, whether you are being targeted, witnessing it, or running an organization where staff are. Written especially for writers, journalists, artists, and activists. (Appears to have geo restrictions.)
* [Games and Online Harassment Hotline Digital Safety Guide](https://gameshotline.org/online-free-safety-guide/): the most granular on specific tactics like doxxing prevention and hate raids, and direct about how well-meaning allies can amplify harassment by stepping in. The hotline closed in October 2023, but the guide is still online.
* [EFF's Surveillance Self-Defense](https://ssd.eff.org/): the deepest on technical infrastructure, with a "Security Scenarios" section that tailors a learning path to your situation.

**On community safety and transformative justice.** [Get in Formation: A Community Safety Toolkit](https://commonslibrary.org/get-in-formation-a-community-safety-toolkit/), from Vision Change Win, collects security and safety practices developed over years within Black, Indigenous, and People of Color movements in the U.S. It covers verbal and physical de-escalation, bystander intervention, and organizational safety planning, with handouts and worksheets you can adapt to your own conditions. It lives on [The Commons Social Change Library](https://commonslibrary.org/), a broader catalogue of openly accessible movement resources worth browsing when your question is harder to name in advance. For the deeper organizing frame, [Beyond Survival: Strategies and Stories from the Transformative Justice Movement](https://www.akpress.org/beyond-survival.html) (Leah Lakshmi Piepzna-Samarasinha and Ejeris Dixon, eds., AK Press, 2020; review on [Autostraddle](https://www.autostraddle.com/beyond-survival-book-review/)) gathers approaches to addressing harm without relying on punishment.
